  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <Card className="bg-gradient-to-br from-teal-500/10 to-emerald-500/10 border-teal-500/30 hover:scale-[1.02] transition-transform">
          <div className="flex items-center gap-4">
        ...
        <Card className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border-emerald-500/30 hover:scale-[1.02] transition-transform">
          <div className="flex items-center gap-4">
